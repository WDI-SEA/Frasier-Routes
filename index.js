...
app.get('/roz', (req, res) => {
    res.send('Let me make this easy for you. Freaks! Freaks on line 1. Freaks on line 2! Freaks! Everywhere!')  
})
...
app.get('/Scrappy', (req, res) => { // these URL patterns are not case-sensitive
    res.send('woof')
})
