...
app.get('/martin', (req, res) => {
    res.send('You may think it\'s tough being middle-aged, but think about me. I got a son who\'s a middle-aged.')
})

app.get('/Scrappy', (req, res) => {
    res.send('woof')
})
//URL's are not case sensitve when tested after testing. 