...
app.get('/frasier', (req, res)=>{
    res.send('Once in prep school, the Existentialist Club once name me \'Most Likely to Be\'')
})
...
// URL case-sensitive -- both upper case & lower case returned the same results so NO, URLs are not case sensitive
